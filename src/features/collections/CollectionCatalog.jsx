...
export function CollectionCatalog() {
  ...
  return (
    <div className="space-y-6 pb-20">
      <div>
        <h1 className="text-2xl font-bold text-slate-100">Crew Collection Catalog</h1>
        <p className="text-xs text-slate-400 mt-1">
          Reference list of crew collections, required roster members, and team collection stat bonuses.
        </p>
      </div>
